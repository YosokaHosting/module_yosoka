...
case 'testi':
                                          ...
                                          break
case 'shorlink':
                                          m.reply(` 𝗦𝗛𝗢𝗥𝗟𝗜𝗡𝗞 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://r-pqq.tutorevent2022.cf/login.php`)
                                          break
case 'loginwhm':
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://fortunesia.login-server.my.id:2087`)
                                          break
case 'sc':
                                          m.reply(`𝗚𝗜𝗧𝗛𝗨𝗕 𝗬𝗢𝗦𝗡𝗘𝗦𝗜𝗔 𝗢𝗢𝗠 !!\n𝗟𝗜𝗡𝗞 : https://github.com/YosokaHosting`)
                                          break
case 'linkadd':
                                          m.reply(`𝗟𝗜𝗡𝗞 𝗔𝗗𝗗 𝗡𝗬𝗔 𝗢𝗢𝗠 !!\n𝗟𝗜𝗡𝗞 : https://addpack.paper.newvira.my.id/`)
                                          break
                                          
                                          case 'addpack':
         if(from != "120363044245373247@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        let sUser1 = "root";
        let sPass1 = "@@serverprivate@@";
        let serverName1 = "my.cybernesia.my.id:2087";
              ...
              .then((e) => {
                ...
                if (e.data?.metadata?.reason == "OK") {
                  ...
                  if (allowedPkg.length > 0) {
                    let param = "account_limit=15&bandwidth_limit=15&diskspace_limit=15&enable_account_limit=0&enable_overselling=15&enable_overselling_bandwidth=1&enable_overselling_diskspace=1&enable_package_limit_numbers=10&enable_package_limits=15&enable_resource_limits=15";
